...
Pod::Spec.new do |s|
    ...
    s.homepage         = 'https://git.wangxutech.com/wxcommlibrarypodscollect/wxioscommonutils'
    # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
    s.license          = { :type => 'MIT', :file => 'LICENSE' }
    s.author           = { 'morty' => 'morty@wangxutech.com' }
    s.source           = { :git => 'https://git.wangxutech.com/wxcommlibrarypodscollect/wxioscommonutils.git', :tag => s.version.to_s }
